...
def main(r_lower=1, r_upper=15, prefix=""):
	...
	dstPaths = ["crossValidationPredictions/boundaries_original_algo_3d_skeletonize_spur_removal/strictVersion/boundary_wo1/test",]
				# "crossValidationPredictions/boundaries_original_algo_3d_skeletonize_spur_removal/boundary_strict_wo2/test",
				# "crossValidationPredictions/boundaries_original_algo_3d_skeletonize_spur_removal/boundary_strict_wo3/test",
				# "crossValidationPredictions/boundaries_original_algo_3d_skeletonize_spur_removal/boundary_strict_wo4/test",
				# "crossValidationPredictions/boundaries_original_algo_3d_skeletonize_spur_removal/boundary_strict_wo5/test",
				# "crossValidationPredictions/boundaries_original_algo_3d_skeletonize_spur_removal/boundary_strict_wo6/test",
				# "crossValidationPredictions/boundaries_original_algo_3d_skeletonize_spur_removal/boundary_strict_wo7/test",
				# "crossValidationPredictions/boundaries_original_algo_3d_skeletonize_spur_removal/boundary_strict_wo8/test",
				# "crossValidationPredictions/boundaries_original_algo_3d_skeletonize_spur_removal/boundary_strict_wo9/test",
				# "crossValidationPredictions/boundaries_original_algo_3d_skeletonize_spur_removal/boundary_strict_wo10/test",
				# "crossValidationPredictions/boundaries_original_algo_3d_skeletonize_spur_removal/boundary_strict_wo11/test",
				# "crossValidationPredictions/boundaries_original_algo_3d_skeletonize_spur_removal/boundary_strict_wo12/test",
				# "crossValidationPredictions/boundaries_original_algo_3d_skeletonize_spur_removal/boundary_strict_wo13/test",
				# "crossValidationPredictions/boundaries_original_algo_3d_skeletonize_spur_removal/boundary_strict_wo14/test",
				# "crossValidationPredictions/boundaries_original_algo_3d_skeletonize_spur_removal/boundary_strict_wo15/test"]
